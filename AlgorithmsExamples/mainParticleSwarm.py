...
class Window(QWidget):
    ...
    def step(self):
        ...
        print "Iteration {0} best:".format(self.algorithm.iteration)
        print self.algorithm.gBest

    @QtCore.pyqtSlot()
    def run(self):
        print 'Method not implemented'
        # if self.algorithm is None:
        #     self.algorithm = EA.SOMA(
        #         self.actualPopulation,
        #         self.fitnessFunction,
        #         self.specimenTemplate,
        #         self.updateCallback)
